    ...
    for(var i=0;i<array_size-1;i++)
    {
        ...
        for(var j=i+1;j<array_size;j++)
        {
            ...
            if(div_sizes[j]<div_sizes[index_min])
            {
                if(index_min!=i)
                {
                    div_update(divs[index_min],div_sizes[index_min],"#337DFF");//Color update
                }
                index_min=j;
                div_update(divs[index_min],div_sizes[index_min],"#FF3333");//Color update
            }
            else
            {
        ...
        if(index_min!=i)
        {
            ...
            div_update(divs[index_min],div_sizes[index_min],"#FF3333");//Height update
