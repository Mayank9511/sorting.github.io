...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"#FFF633");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"#337DFF");//Height update
                div_update(divs[j],div_sizes[j],"#337DFF");//Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"#FF3333");//Color update
    ...
    div_update(divs[start],div_sizes[start],"#FF3333");//Height update
